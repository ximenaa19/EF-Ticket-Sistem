...
public sealed class AircraftManufacturerRepository : RepositoryBase<AircraftManufacturer>, IAircraftManufacturer
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return Context.Set<AircraftManufacturer>().AnyAsync(
